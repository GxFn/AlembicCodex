...
export class SetupService {
    ...
    constructor(options) {
        ...
        if (existingEntry && explicitGhost !== undefined && existingEntry.ghost !== explicitGhost) {
            ...
            throw new Error(`[SetupService] Existing Alembic workspace is ${existingMode}; requested ${requestedMode}. ` +
    ...
    async stepVectorIndex() {
        try {
            ...
            if (!container.services.vectorService) {
                return {
                    status: 'skipped',
                    reason: 'vectorService 未注册（embedded runtime 保持 baseline search，未启用 resident vector enhancement）',
