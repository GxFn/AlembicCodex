...
async function _prime(ctx, args) {
    ...
    if (primeKnowledgeMaterial.status === 'degraded') {
        ...
        lines.push('📣 Codex must immediately tell the developer which Recipe/Guard knowledge it accepted and cite the available evidenceRefs before any further tool call, code reading, edit, Guard check, or final summary.');
    }
    else {
