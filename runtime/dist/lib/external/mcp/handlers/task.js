...
async function _prime(ctx, args) {
    ...
    if (primeKnowledgeMaterial.status === 'degraded') {
        ...
        lines.push('📣 Codex must immediately shout in the first person that it did not receive usable project knowledge because prime degraded before any further tool call, code reading, edit, Guard check, or final summary. Do not make Alembic prime the speaker or subject.');
    }
        ...
        lines.push('📣 Codex must immediately shout in the first person that it did not receive usable project knowledge before any further tool call, code reading, edit, Guard check, or final summary. Do not make Alembic prime the speaker or subject.');
    }
    return envelope({
        success: true,
        data: {
