...
export const CODEX_LOCAL_TOOLS = [
    ...
    },
    {
        ...
        tier: 'agent',
        description: 'Start or connect to the project Alembic daemon and return the local Dashboard URL plus follow-up job actions. If the workspace is not initialized yet, this first performs safe Ghost initialization.',
        inputSchema: codexInputSchema(),
    },
    {
