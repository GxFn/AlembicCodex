...
export function summarizeEnhancementDaemon(status) {
    ...
    const capabilitySummary = mergeCapabilitySummaryWithResidentService(mergeCapabilitySummaryWithRuntimeBoundary(summarizeAlembicRuntimeCapabilities(capabilities), runtimeBoundary), residentServiceStatus);
