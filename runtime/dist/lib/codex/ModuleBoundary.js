import { CODEX_EMBEDDED_RUNTIME_REQUIRED_FILES, CODEX_EMBEDDED_RUNTIME_REQUIRED_ROUTES, CODEX_EMBEDDED_RUNTIME_RETAINED_DAEMON_ENTRY, } from './runtime/EmbeddedRuntimeContract.js';
...
export const CODEX_DASHBOARD_ARTIFACT_BOUNDARY = {
    ...
    localDaemonRequirement: 'alembic_codex_dashboard returns a URL only from a local Alembic daemon that advertises Dashboard capability.',
...
const PLUGIN_OWNED_BOUNDARIES = [
    ...
    },
    {
        ...
        retainedInPlugin: true,
        sourceOfTruth: 'lib/codex/mcp/handlers/host-agent/** + lib/codex/mcp/host-agent-workflows/** with @alembic/core/host-agent-workflows',
    },
    {
    ...
    },
    {
        ...
        owner: 'AlembicPlugin',
        pluginRole: 'Packages compiled Plugin runtime, embedded Core snapshot, and Codex wrapper without Dashboard frontend assets.',
        retainedInPlugin: true,
    ...
    },
    {
        ...
        owner: 'AlembicPlugin',
        pluginRole: 'Presents Codex host project alignment and returns a Dashboard URL only when Alembic selected/active runtime already matches the host project.',
        retainedInPlugin: true,
    ...
    },
    {
        ...
        owner: 'AlembicPlugin',
        pluginRole: 'Reads Core project/runtime state for Codex-visible mismatch guidance; never switches Alembic projects.',
        retainedInPlugin: true,
        sourceOfTruth: 'lib/codex/HostProjectAlignment.ts',
    },
];
const EXTERNAL_OWNED_BOUNDARIES = [
    {
        id: 'alembic-daemon-main',
        owner: 'Alembic',
        pluginRole: 'Consumes daemon health/state/capability shape or starts embedded compatibility runtime.',
    ...
    },
    {
        ...
        owner: 'AlembicCore',
        pluginRole: 'Uses public WorkspaceResolver/ProjectRegistry contract; does not define registry rules.',
        retainedInPlugin: false,
    ...
    },
    {
        id: 'job-store-main',
        owner: 'AlembicCore',
        pluginRole: 'Reads/writes job records through public JobStore as daemon/job compatibility storage.',
        retainedInPlugin: false,
    ...
    },
    {
        ...
        owner: 'Alembic',
        pluginRole: 'Keeps only embedded runtime checkpoint compatibility; long-lived daemon file monitoring belongs outside Plugin.',
        retainedInPlugin: false,
    ...
    },
    {
        ...
        owner: 'AlembicAgent',
        pluginRole: 'Surfaces provider readiness for explicit internal AI daemon jobs; Codex host-agent route does not require it.',
        retainedInPlugin: false,
    ...
    },
    {
        ...
        pluginRole: 'Receives Dashboard URL handoff from Alembic; Plugin does not build, copy, package, or serve Dashboard frontend assets.',
        retainedInPlugin: false,
...
export function buildCodexModuleBoundaryStatus(input = {}) {
    ...
    return {
        ...
        adapters: {
            ...
            runtimeContract: {
                capabilitySummarySource: '@alembic/core/daemon#residentService and explicit capability sections',
