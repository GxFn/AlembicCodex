...
import { createCleanMcpErrorResponse, createMcpStructuredToolResult, isMcpCallToolResult, serializeMcpToolResult, withMcpOutputSchema, } from './output-contract.js';
...
export class McpServer {
    ...
    _resolveHandler(name) {
        const HANDLER_MAP = {
            ...
            alembic_decision_record: (ctx, args) => agentPublicToolHandlers.decisionRecordHandler(ctx, args),
            ...
            alembic_bootstrap: (ctx, _args) => bootstrapForHostAgent(ctx),
            alembic_rescan: (ctx, args) => rescanForHostAgent(ctx, args),
            alembic_evolve: (ctx, args) => evolveForHostAgent(ctx, args),
