...
export async function resetPluginOwnedMcpServer() {
...
export class CodexEmbeddedToolExecutor {
    ...
    async execute(name, args, serviceBoundary, executionContext, options = {}) {
        ...
        try {
            ...
            return attachCodexExecutionContext(attachCodexServiceBoundary(result, serviceBoundary), executionContext, this.#hostProjectRoot);
        }
        catch (err) {
            const message = err instanceof Error ? err.message : String(err);
            return attachCodexExecutionContext(attachCodexServiceBoundary(failureResult(name, `Plugin-owned Codex tool execution failed: ${message}`), serviceBoundary), executionContext, this.#hostProjectRoot);
        }
    }
