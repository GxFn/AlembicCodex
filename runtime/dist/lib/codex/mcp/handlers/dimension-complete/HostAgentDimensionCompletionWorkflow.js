...
export async function runHostAgentDimensionCompletionWorkflow(ctx, args, dependencies = {}) {
...
async function resolveHostAgentCompletionSession({ ctx, input, dependencies, }) {
...
async function createHostAgentDimensionSkill({ ctx, dimension, dimensionId, analysisText, referencedFiles, keyFindings, submittedRecipeIds, dependencies, }) {
...
function emitHostAgentCompletionProgress({ ctx, session, dimension, dimensionId, candidateCount, skillCreated, recipesBound, progress, isComplete, dependencies, }) {
