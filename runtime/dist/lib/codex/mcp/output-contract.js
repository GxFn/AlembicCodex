...
const outputProjectors = new Map();
export function registerMcpOutputProjector(projector) {
...
export function getMcpOutputProjector(toolName) {
    return outputProjectors.get(toolName) ?? null;
}
export function projectMcpToolOutput(toolName, value) {
...
export function isCleanMcpResponse(value) {
    return CleanMcpResponseSchema.safeParse(value).success;
}
export function isMcpCallToolResult(value) {
    return (!!value && typeof value === 'object' && Array.isArray(value.content));
}
export function createCleanMcpResponse(input, toolName) {
...
export function createMcpStructuredToolResult(response) {
...
export function serializeMcpToolResult(toolName, value, options) {
...
export function withMcpOutputSchema(tool) {
...
function projectLegacyErrorAsCleanResponse(toolName, value) {
