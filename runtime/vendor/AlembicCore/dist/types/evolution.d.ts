...
/** 状态转移触发类型 */
export type TransitionTrigger = 'confidence-route' | 'grace-period-expire' | 'guard-conflict' | 'proposal-execution' | 'proposal-attach' | 'content-patch-complete' | 'decay-detection' | 'manual-deprecation' | 'evolution-gateway' | 'timeout-recovery' | 'evidence-recovery' | 'resurrection';
/** 状态转移证据 */
