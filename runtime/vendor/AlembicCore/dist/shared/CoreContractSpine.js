...
export const CORE_LEGACY_CONTRACT_CONVERGENCE_CANDIDATES = [
    ...
    {
        cleanupBlocker: 'Already satisfied by CR1 accepted consumer commits and Core canonical-only source-ref deletion.',
        currentCompatibilityOwner: [],
        currentConsumers: [],
        decisionRationale: 'CR1 moved active consumers to projectScopeId and repo-qualified paths, so Core no longer keeps short-path alias lookup as a product contract.',
        id: 'D9-C03',
        legacySurface: 'Old ProjectScope short-path source-ref alias index and resolution reasons.',
        publicExposurePolicy: 'Deleted; product-facing ProjectScope lookup and output use projectScopeId plus repo-qualified paths only.',
        registryRows: ['I05'],
        removalTrigger: 'Satisfied by CR1 accepted consumer commits cd501f9215da3ee1fa2f1af5c99ec485d92b6aa6, fce85ee581dec99f37658e025a7eef331f4db009, and 8bf5115782929514ac762f307cde3f7378936516.',
