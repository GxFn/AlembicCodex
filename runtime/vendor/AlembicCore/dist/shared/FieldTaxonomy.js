...
export function validateCoreFieldPolicies(policies, options = {}) {
    const issues = [];
...
export function summarizeCoreFieldPolicies(policies) {
...
export function isCoreFieldClass(value) {
    return typeof value === 'string' && CORE_FIELD_CLASSES.includes(value);
}
export function isCoreSchemaClosurePolicy(value) {
    return (typeof value === 'string' &&
        CORE_SCHEMA_CLOSURE_POLICIES.includes(value));
}
export function isCoreInterfaceRole(value) {
    return typeof value === 'string' && CORE_INTERFACE_ROLES.includes(value);
}
export function isCoreDiagnosticPolicy(value) {
    return (typeof value === 'string' && CORE_DIAGNOSTIC_POLICIES.includes(value));
}
export function isCoreFieldFailureKind(value) {
    return (typeof value === 'string' && CORE_FIELD_FAILURE_KINDS.includes(value));
}
export function isCorePrivateFieldClass(value) {
    return CORE_PRIVATE_FIELD_CLASSES.includes(value);
}
function collectPolicyShapeIssues(policy, issues, options) {
...
function emptyFieldClassCounts() {
    return {
        public: 0,
        'consumer-needed': 0,
        diagnostic: 0,
...
function emptyExtensionPolicyCounts() {
    return {
        'artifactRef-only': 0,
