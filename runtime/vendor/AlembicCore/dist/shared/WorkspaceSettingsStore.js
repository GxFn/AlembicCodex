...
export function isAiEnvReady(env) {
...
export function collectAiEnv(env = process.env) {
    const result = {};
...
export function collectAiEnvOverrides(baseEnv, env = process.env) {
...
export function maskAiEnvConfig(env) {
    const vars = {};
