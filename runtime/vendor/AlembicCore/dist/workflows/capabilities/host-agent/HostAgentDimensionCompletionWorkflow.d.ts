...
export interface HostAgentDimensionCompletionDependencies {
    getActiveSession?: (container: HostAgentSessionContainer, sessionId?: string) => Promise<HostAgentWorkflowSession | null> | HostAgentWorkflowSession | null;
 ...
 */
export declare function runHostAgentDimensionCompletionWorkflow(ctx: HostAgentDimensionCompletionContext, args: HostAgentDimensionCompleteArgs, dependencies?: HostAgentDimensionCompletionDependencies): Promise<HostAgentDimensionCompletionResponse>;
export {};
