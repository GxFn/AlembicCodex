...
// ═══════════════════════════════════════════════════════════════
export const sourceGraphGenerations = sqliteTable('source_graph_generations', {
    id: integer('id').primaryKey({ autoIncrement: true }),
...
// ═══════════════════════════════════════════════════════════════
export const sourceGraphFiles = sqliteTable('source_graph_files', {
    id: integer('id').primaryKey({ autoIncrement: true }),
    generationId: text('generation_id').notNull(),
    projectRoot: text('project_root').notNull(),
    ...
    uniqueIndex('source_graph_files_generation_path_unique').on(table.generationId, table.repoRelativePath),
...
// ═══════════════════════════════════════════════════════════════
export const sourceGraphSymbols = sqliteTable('source_graph_symbols', {
    id: integer('id').primaryKey({ autoIncrement: true }),
    generationId: text('generation_id').notNull(),
    projectRoot: text('project_root').notNull(),
    ...
    uniqueIndex('source_graph_symbols_generation_symbol_unique').on(table.generationId, table.symbolId),
...
// ═══════════════════════════════════════════════════════════════
export const sourceGraphEdges = sqliteTable('source_graph_edges', {
    id: integer('id').primaryKey({ autoIncrement: true }),
    generationId: text('generation_id').notNull(),
    projectRoot: text('project_root').notNull(),
